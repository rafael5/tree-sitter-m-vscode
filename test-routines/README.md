...
[`tree-sitter-m/docs/discoveries.md`](https://github.com/m-dev-tools/tree-sitter-m/blob/main/docs/discoveries.md);
the upstream-actionable one is also on m-standard's
[`docs/build-log.md` BL-014](https://github.com/m-dev-tools/m-standard/blob/main/docs/build-log.md#bl-014).
Summarised here so test-routine authors don't trip on them again:

- **[DISC-001](https://github.com/m-dev-tools/tree-sitter-m/blob/main/docs/discoveries.md#disc-001)** —
  ...
  ships.
- **[DISC-002](https://github.com/m-dev-tools/tree-sitter-m/blob/main/docs/discoveries.md#disc-002)** —
...
- **[DISC-003](https://github.com/m-dev-tools/tree-sitter-m/blob/main/docs/discoveries.md#disc-003)** —
